...
const ShowAlldata = ({ data }) => {
    ...
    return (
        ...
        <div style={{ alignItems: 'center' }} className="px-2 flex pt-5 sm:pt-0 sm:w-5/12 sm:mx-5 card border-8 border-purple-300 lg:card-side bg-base-100 shadow-xl my-3">
